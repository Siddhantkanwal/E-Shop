...
import com.example.shopping.adapter.AddressListAdapter
...
import com.example.shopping.models.SwipeToDeleteCallback
import com.example.shopping.models.SwipeToEditCallback
...
class AddressListActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // START
        if (mSelectAddress) {
            tv_title1.text= resources.getString(R.string.title_select_address)
        }
        // END
