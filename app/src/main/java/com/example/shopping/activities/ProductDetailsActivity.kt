...
import com.example.shopping.models.GlideLoader
...
class ProductDetailsActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // START
        if (intent.hasExtra(com.example.shopping.models.Constants.EXTRA_PRODUCT_ID)) {
            mProductId =
                intent.getStringExtra(com.example.shopping.models.Constants.EXTRA_PRODUCT_ID)!!
        ...
        if (intent.hasExtra(com.example.shopping.models.Constants.EXTRA_PRODUCT_OWNER_ID)) {
            productOwnerId = intent.getStringExtra(com.example.shopping.models.Constants.EXTRA_PRODUCT_OWNER_ID)!!
        }
        // END
        getProductDetails()
    ...
    private fun addToCart() {
        ...
        val addToCart = CartItem(
            ...
            com.example.shopping.models.Constants.DEFAULT_CART_QUANTITY
        )
