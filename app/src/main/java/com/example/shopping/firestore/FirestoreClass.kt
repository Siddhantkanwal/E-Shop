...
import com.example.shopping.activities.ui.dashboard.DashboardFragment
import com.example.shopping.activities.ui.home.HomeFragment
import com.example.shopping.activities.ui.notifications.NotificationsFragment
...
//         Delete the list of cart items
     ...
     */
    fun getMyOrdersList(fragment: NotificationsFragment) {
        mFireStore.collection(Constants.ORDERS)
            .whereEqualTo(Constants.USER_ID, getCurrentUserID())
            .get() // Will get the documents snapshots.
            .addOnSuccessListener { document ->
